...
BUFSIZ = 1024*2  #接收数据缓冲大小
local_addr =  ('10.8.13.222',43642)
server_addr_p = ('10.9.61.180',5060)
...
send_data_subscribe = bytes(f'''SUBSCRIBE sip:88116000040@ims.mnc008.mcc468.3gppnetwork.org;transport=UDP SIP/2.0\r\n\
Via: SIP/2.0/UDP 10.8.13.114:43642;branch={branch}\r\n\
Max-Forwards: 70\r\n\
Contact: <sip:88116000040@10.8.13.222:43642;transport=UDP>\r\n\
